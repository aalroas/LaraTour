...
<div class="ml-lg-auto text-left text-lg-right mt-20 mt-lg-0">
    ...
    <div class="price"> <span> <span><?php echo e($tour->price); ?></span></span></div>
...
<?php $__currentLoopData = $tour->tour_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

<div>
    <div class="image"><img  style="height: 620px !important;" src="<?php echo e(URL::to('uploads/tour',$tour->tour_images[$image]->tour_image_path)); ?>"
...
<div>
    <div class="image"><img   style="height: 100px;width: 100px;"  src="<?php echo e(URL::to('uploads/tour',$tour->tour_images[$image]->tour_image_path)); ?>"
            alt="<?php echo e($title); ?>" /></div>
</div>
                                            ...
                                            <div class="row gap-10 mb-15 align-items-sm-center">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="tour_name" data-placeholder="Please select" class="chosen-no-search form-control"
                                                            tabindex="2">
                                                            <option></option>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-icon-left">
                                                                        ...
                                                                        <input name="tour_date" type="text"
                                                                            ...
                                                                            placeholder="<?php echo e(trans('frontend.pick_a_month')); ?>" data-min-view=" months"
                                                                            data-view="months" data-date-format="MM yyyy" data-language="en"
                                                                            data-auto-close="true" readonly>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-icon-left">
                                                                        ...
                                                                        <input type="text" name="guests"
                                                                            class="form-control touch-spin-03 form-readonly-control" placeholder="0" readonly />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col-12">
                                                    <button class="btn btn-primary btn-block" type="submit" id="send_form4"><?php echo e(trans('frontend.reserve_now')); ?>
