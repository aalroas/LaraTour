                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><?php echo e(trans('backend.users')); ?></li>
                        </ol>
                    </nav>
                </div>
                <div class="col-md-6 col-sm-12 text-right hidden-xs">
                    <a href="<?php echo e(route('user.create')); ?>" class="btn btn-sm btn-primary" title="">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"> <img style="height: 50px;width: 50px;" class="img-circle"
                                                src="<?php echo e(URL::to('uploads/users/')); ?>/<?php echo e($user->image); ?>"></td>
                                        ...
                                        <td><?php if($user->status == 1): ?> <?php echo e(trans('backend.yes')); ?> <?php else: ?>
                                            <?php echo e(trans('backend.no')); ?> <?php endif; ?></td>


                                        <td> <a href="<?php echo e(route('user.edit',$user->id)); ?>"> <i
                                        ...
                                        <td>
                                            ...
                                            <a href=""
                                                onclick="if(confirm('Are You sure you want to delete this')){event.preventDefault();document.getElementById('delete-form-<?php echo e($user->id); ?>').submit();}else{event.preventDefault();}">
