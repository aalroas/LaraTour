...
<form role="form" action="<?php echo e(route('room.store')); ?>" method="post" enctype="multipart/form-data">
...
<div class="col-sm-8">
              ...
              <div class="file-loading">
                    <input id="file-1" type="file" name="room_images[]" multiple class="file" data-overwrite-initial="false"
...
<div class="col-sm-4">
        <div class="card">
            <div class="header">
                <h2><?php echo e(trans('backend.price')); ?> TR</h2>
            </div>
            <div class="body">
            ...
            <div class="box-footer">
              ...
              <a  type="button"  class="btn btn-warning" href="<?php echo e(route('room.index')); ?>"><?php echo e(trans('backend.back')); ?></a>
            </div>
          </form>
