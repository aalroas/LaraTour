                        ...
                        <div class="container">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><?php echo e(trans('frontend.rooms')); ?></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<div class="col">
    ...
    <div class="product-grid-item">
        ...
        <a href="<?php echo e(route('room',$room->slug)); ?>">

            <div class="image">
                <img src="<?php echo e(URL::to('uploads/room',$room->f_image)); ?>" alt="<?php echo e($title); ?>">
            </div>
...
<?php $__currentLoopData = $room->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                    ...
                    <p class="location"><i class="fas fa-map-marker-alt text-primary"></i><?php echo e(trans('frontend.type')); ?> : <?php echo e($cat); ?></p>
