  ...
  public function __construct()
  {
    ...
    public function updateSiteInfo(Request $request)
    {
        ...
        if (!empty($Setting)) {
            ...
            $Setting->booking_url = $request->booking_url;

            $Setting->booking_text_ar = $request->booking_text_ar;
            $Setting->booking_text_en = $request->booking_text_en;
            $Setting->booking_text_tr = $request->booking_text_tr;
...
// icon icin
            ...
            $Setting->save();
           return redirect(route('setting.edit'))->with('message','Setting updated successfully');
