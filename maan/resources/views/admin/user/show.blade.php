                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ trans('backend.users') }}</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-md-6 col-sm-12 text-right hidden-xs">
                    <a href="{{   route('user.create')   }}" class="btn btn-sm btn-primary" title="">
                        {{ trans('backend.new') }}</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"> <img style="height: 50px;width: 50px;" class="img-circle"
                                                src="{{  URL::to('uploads/users/')}}/{{ $user->image }}"></td>
                                        ...
                                        <td>@if($user->status == 1) {{ trans('backend.yes') }} @else
                                        ...
                                        <td>
                                            ...
                                            <a href=""
                                                onclick="if(confirm('Are You sure you want to delete this')){event.preventDefault();document.getElementById('delete-form-{{ $user->id }}').submit();}else{event.preventDefault();}">
