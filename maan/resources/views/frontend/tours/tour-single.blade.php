...
<div class="ml-lg-auto text-left text-lg-right mt-20 mt-lg-0">
    ...
    <div class="price"> <span> <span>{{ $tour->price}}</span></span></div>
...
@foreach($tour->tour_images as $image => $value)

<div>
    <div class="image"><img  style="height: 620px !important;" src="{{ URL::to('uploads/tour',$tour->tour_images[$image]->tour_image_path) }}"
            alt="{{ $title }}" /></div>
</div>
...
<div>
    <div class="image"><img   style="height: 100px;width: 100px;"  src="{{ URL::to('uploads/tour',$tour->tour_images[$image]->tour_image_path) }}"
            alt="{{ $title }}" /></div>
</div>
                                    ...
                                    <div class="row gap-10 gap-xl-20 align-items-end">
                                        ...
                                        <div class="form-inner">
                                            ...
                                            <div class="row gap-10 mb-15 align-items-sm-center">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-icon-left">
                                                                        ...
                                                                        <input name="tour_date" type="text"
                                                                            ...
                                                                            placeholder="{{ trans('frontend.pick_a_month')}}" data-min-view=" months"
                                                ...
                                                <div class="col-12">
                                                    <button class="btn btn-primary btn-block" type="submit" id="send_form4">{{ trans('frontend.reserve_now') }}
                                                    </button>
                                                </div>
