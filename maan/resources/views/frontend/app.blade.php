...
<head>
    ...
    <script src="{{ asset('frontend/ajax/jquery-2.2.4.min.js') }}"></script>
    <script src="{{ asset('frontend/ajax/jquery-ui.min.js') }}"></script>
    <script src="{{ asset('frontend/ajax/jquery-plugin-collection.js') }}"></script>
...
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/{{trans('frontend.local_code')}}/sdk.js#xfbml=1&version=v6.0&appId=290943455212632&autoLogAppEvents=1"></script>
@php
   $rtl ="";
   if (trans('frontend.direction')=="rtl") {
       $rtl ="true";
