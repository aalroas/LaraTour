                        ...
                        <div class="container">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">{{ trans('frontend.rooms') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<div class="col">
    ...
    <div class="product-grid-item">
        ...
        <a href="{{ route('room',$room->slug) }}">
            ...
            <div class="image">
                <img src="{{ URL::to('uploads/room',$room->f_image) }}" alt="{{ $title }}">
            </div>
...
@foreach ($room->categories as $category => $value)
                ...
                @endphp
                    ...
                    <p class="location"><i class="fas fa-map-marker-alt text-primary"></i>{{ trans('frontend.type') }} : {{ $cat }}</p>
@endforeach
                </div>
                <div class="price">
