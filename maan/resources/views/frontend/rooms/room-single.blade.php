...
<div class="ml-lg-auto text-left text-lg-right mt-20 mt-lg-0">
    ...
    <div class="price"> <span> <span>{{ $room->price}}</span></span></div>
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="slick-gallery-slideshow detail-gallery">
                            ...
                            <div    class="slider gallery-slideshow">
                               ...
                               @foreach($room->room_images as $image => $value)

                                <div>
                                    <div    class="image"><img   style="height:620px !important;" src="{{ URL::to('uploads/room',$room->room_images[$image]->room_image_path) }}"
                                            alt="{{ $title }}" /></div>
                                </div>
...
@foreach($room->room_images as $image => $value)
                                ...
                                <div>
                                    <div class="image"><img  style="height: 100px;width: 100px;" src="{{ URL::to('uploads/room',$room->room_images[$image]->room_image_path) }}"
                                            alt="{{ $title }}" /></div>
                                </div>
                                                ...
                                                <div class="col-12 ">
                                                        ...
                                                        <div class="row gap-10 mb-15">
                                                            ...
                                                            <div class="col-4 col-sm-6 col-md-4">
                                                                <div class="form-group form-spin-group">
                                                                    <label
                                                                        for="room-amount">{{ trans('frontend.rooms') }}</label>
                                                                    <div class="form-icon-left">
                                                                        <span class="icon-font text-muted"><i
                                                                    ...
                                                                    <div class="form-people-thread">
                                                                        <div class="row gap-5 align-items-center">
                                                                            <div class="col">
                                                                                <div class="form-group form-spin-group">
                                                                                    <label
                                                                                        for="room-amount">{{ trans('frontend.adults') }}
                                                                                        <small
                                                                            ...
                                                                            <div class="col">
                                                                                <div class="form-group form-spin-group">
                                                                                    <label
                                                                                        for="room-amount">{{ trans('frontend.children') }}
                                                                                        <small
                                                    ...
                                                    <div class="col-12">
                                                        <button class="btn btn-primary btn-block" type="submit"
                                                            id="send_form">{{ trans('frontend.reserve_now') }} </button>
                                                    </div>
