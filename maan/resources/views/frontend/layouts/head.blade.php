...
<!-- Title Of Site -->
<title>{{ GeneralSiteSettings("site_title_" . trans('frontend.boxCode')) }} @if (ucfirst(Request::segment(1)) != "")
...
<meta property="og:title"
    content="{{ GeneralSiteSettings("site_title_" . trans('frontend.boxCode')) . " | "  . ucfirst(Request::segment(1)) }}">
<meta property="og:image"
    content="{{ URL('uploads/settings/'. GeneralSiteSettings("site_logo_".trans('frontend.boxCode')))}}">
<meta name="twitter:image"
    content="{{ URL('uploads/settings/'. GeneralSiteSettings("site_logo_".trans('frontend.boxCode')))}}">
<meta name="twitter:title" content="{{ GeneralSiteSettings("site_title_" . trans('frontend.boxCode'))}}">
<meta property="og:description"
    content="{{ GeneralSiteSettings("site_meta_description_" . trans('frontend.boxCode'))}}">
